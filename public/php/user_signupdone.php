...
<body>
        ...
        <div class="container py-5" style="height: 100vh !important;">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-6 col-xl-5 my-5 my-lg-0 text-center text-md-start">
                    <h1 class="h1 light-text-color mt-0">Your account has been created.</h1>
                    <h4 class="h4 light-text-color" style="margin-top: 35px">Login to start booking an appointment today!</h4>
                    <div class="cta" style="margin-top: 35px">
                        <a href="./index.php"><button class="btn primary-color btn-round mb-3 mb-sm-0"><span class="btn-text">Log In</span></button></a>
                        <a href="./clinic_login.php"><button class="btn light-text-color btn-round btn-outline mb-3 mb-sm-0 mx-2"><span class="btn-text">Clinic Log In</span></button></a></div>
                </div>
                <div class="col-lg-6 col-xl-4">
                    <div class="card-item round light-background-color" style="padding: 40px 40px">
                        <h3 class="h3 text-color text-center">Customer Account Details</h3>
                        <div class="card-content" style="margin-top: 40px">
                            <div class="form-group"><label class="h6">You have registered as:</label>
                                <!-- changed from php to js -->
                                <div class="form-group" style="color: #FFBDD5; ;" id="user_username"><label class="h4"></label></div>
                            </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById("user_username").innerText = user_username
    </script>
</body>
